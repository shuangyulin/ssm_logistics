    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>WorkMan/frontlist">工作人员</a></li>
                <li><a href="<%=basePath %>Cangku/frontlist">仓库</a></li>
                <li><a href="<%=basePath %>Wuzi/frontlist">物资</a></li>
                <li><a href="<%=basePath %>Ruku/frontlist">入库</a></li>
                <li><a href="<%=basePath %>Chuku/frontlist">出库</a></li>
                <li><a href="<%=basePath %>WuziClass/frontlist">物资种类</a></li>
